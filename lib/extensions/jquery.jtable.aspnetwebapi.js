    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        *************************************************************************/
        ...
        _convertDateToIsoString: function(fields, record) {
            ...
            for (var fieldKey in fields) {
                ...
                if (field.type == 'date') {
                    ...
                    if (val) {
                        var date = this._stringToDate(val, field.displayFormat);
                        val = date.format("yyyy-MM-ddTHH:mm:ss");
                        record[fieldKey] = val;
                    } else {
        ...
        _toIsoDateTime : function (dateInShortFormatString, timeString) {
            ...
            oculus.debugLog(dateValues);
            oculus.debugLog(timeValues);
